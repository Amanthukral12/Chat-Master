...
const { Users } = require("./utils/users"), { isRealString } = require("./utils/isRealString"), { generateMessage, generateLocationMessage, generateTypingMessage } = require("./utils/message");
